...
enum {
	...
	MX51_PAD_EIM_CS1__GPIO2_26		= IOMUX_PAD(0x478, 0x0e4, 1, __NA_, 0, MX51_GPIO_PAD_CTRL),
	...
	MX51_PAD_CSI1_HSYNC__GPIO3_15		= IOMUX_PAD(0x5b0, 0x1c8, 3, __NA_, 0, MX51_GPIO_PAD_CTRL),
